...
const CardsListEl = props => {
  return (
    ...
    >
      ...
      <small className="text-muted">
        Daily limits: {props.dailyOnlineLimit} (online),{" "}
        {props.dailyWithdrawalLimit} (withdrawal)
      </small>
      <br />
      <small className="text-muted">
        Monthly limits: {props.monthlyOnlineLimit} (online),{" "}
        {props.monthlyWithdrawalLimit} (withdrawal)
      </small>
    </Link>
  );
};
